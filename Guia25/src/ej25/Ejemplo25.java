 ...
 * @author USER
 */
public class Ejemplo25 extends javax.swing.JFrame {
    
    JCheckBox vcuadros[];
    JButton btnAceptar;

    /**
     * Creates new form Ejemplo25
     */
    public Ejemplo25() {
        initComponents();
        creacionVentana();
    ...
    public void creacionVentana() {
        ...
        String vtextos[] = {"rojo","verde","azul","rosa","celeste","morado",
            "amarillo","marron","naranja","blanco"};
        int i;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejemplo25.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
