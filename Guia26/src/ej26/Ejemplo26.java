 ...
 * @author USER
 */
public class Ejemplo26 extends javax.swing.JFrame {

    JButton vBotones[];

    /**
     * Creates new form Ejemplo26
     */
    public Ejemplo26() {
        initComponents();
        creacionVentana();
    ...
    public void creacionVentana() {
        this.setTitle("Ejemplo vectores y eventos");
        this.setSize(600, 200);

        String textoBotones[] = {"Aceptar", "Cancelar", "Aplicar", "Cerrar", "Salir"};

        vBotones = new JButton[textoBotones.length];
        int i;
        ...
        for (i = 0; i<vBotones.length; i++) {
            vBotones[i].addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
                    botonesActiobPerformed(evt);
                }
            });
        }
    }
    
    public void botonesActiobPerformed(ActionEvent evt){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejemplo26.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
