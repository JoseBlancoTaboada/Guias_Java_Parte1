 ...
 * @author USER
 */
public class Ejemplo23 extends javax.swing.JFrame {
    
    JLabel etiTexto;
    JLabel etiZona;

    /**
     * Creates new form Ejemplo23
     */
    public Ejemplo23() {
        initComponents();
        creacionVentana();
    ...
    public void etiZonaMousePressed(MouseEvent evt){
        if (evt.getButton()==MouseEvent.BUTTON1){
            etiTexto.setText("Acaba de pulsar el boton izquierdo");
        } else if (evt.getButton()==MouseEvent.BUTTON2) {
            etiTexto.setText("Acaba de pulsar el boton central");
        }else if (evt.getButton()==MouseEvent.BUTTON3) {
            etiTexto.setText("Acaba de pulsar el boton derecho");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejemplo23.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
